...
var LiquidButton = function () {
  function LiquidButton(svg) {
    ...
    this.forceFactor = options.forceFactor || 0.2;
      this.color1 = options.color1 || '#1616cf';
      this.color2 = options.color2 || '#864dff';
      this.color3 = options.color3 || '#864dff';
    this.textColor = options.textColor || '#FFFFFF';
    this.text = options.text || 'Написать нам';
    this.svg = svg;
    this.layers = [{
      points: [],
      viscosity: 0.5,
    ...
    this.svgText.setAttribute('dy', ~ ~(this.height / 8) + 'px');
      this.svgText.setAttribute('font-size', '2.5vw');
      this.svgText.setAttribute('letter-spacing', '2');
      this.svgText.setAttribute('font-weight', '100');
    this.svgText.style.fontFamily = 'Raleway, sans-serif';
